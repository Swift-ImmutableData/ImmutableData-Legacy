...
extension ImmutableUI.Selector {
  ...
  ) where Store == ImmutableData.Store<AnimalsState, AnimalsAction>, Dependency : Equatable, Output : Equatable {
    self.init(
      id: id,
      label: label,
      filter: isIncluded,
...
extension ImmutableUI.Selector {
  init(
    ...
    filter isIncluded: (@Sendable (Store.State, Store.Action) -> Bool)? = nil,
    outputSelector: @escaping @Sendable (Store.State) -> Output
  ) where Store == ImmutableData.Store<AnimalsState, AnimalsAction>, Dependency == Never, Output : Equatable {
    self.init(
      id: id,
      label: label,
      filter: isIncluded,
...
@MainActor @propertyWrapper struct SelectCategory: DynamicProperty {
  @ImmutableUI.Selector<ImmutableData.Store<AnimalsState, AnimalsAction>, Never, AnimalsData.Category?> var wrappedValue: AnimalsData.Category?
...
@MainActor @propertyWrapper struct SelectAnimal: DynamicProperty {
  @ImmutableUI.Selector<ImmutableData.Store<AnimalsState, AnimalsAction>, Never, Animal?> var wrappedValue: Animal?
...
@MainActor @propertyWrapper struct SelectAnimalStatus: DynamicProperty {
  @ImmutableUI.Selector<ImmutableData.Store<AnimalsState, AnimalsAction>, Never, Status?> var wrappedValue: Status?
